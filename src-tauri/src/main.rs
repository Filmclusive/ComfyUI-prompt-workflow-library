...
fn ensure_app_dirs(app: &tauri::AppHandle) -> Result<(), String> {
    ...
    crate::default_workflows::install_default_workflows(&global_workflows_dir)
        .map_err(|e| e.to_string())?;
    Ok(())
}
...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::workflows::get_workflow_json,
            commands::workflows::open_workflow_in_comfyui,
            commands::workflows::reveal_workflow_json,
            ...
            // ComfyUI
            commands::comfyui::find_comfyui_application,
